...
await Firebase.initializeApp(
  options: FirebaseOptions(apiKey: "AIzaSyDx0vDZxC0-_wtbhgT-DTbAcV5NW8lyvO8",
  authDomain: "teacher-data-management.firebaseapp.com",
  projectId: "teacher-data-management",
  storageBucket: "teacher-data-management.appspot.com",
  messagingSenderId: "412655788931",
  appId: "1:412655788931:web:d0af1bb2ef41cdd0d40cb6",
  measurementId: "G-974WTDPNSX")
);
  runApp(MyApp());
}
        ...
        child: Align(
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text('Teacher Data Management'),
              style: ButtonStyle(
...
class StudentDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Image.asset(
          'assets/images/stud1.jpg', // Replace with the actual image path
          fit: BoxFit.cover,
          width: 500,
          height: 800,
        ),
